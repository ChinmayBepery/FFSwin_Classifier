...
def main():
    parser = argparse.ArgumentParser(
        description="3D ResNet-18 Training (Patient-wise, Class-weighted)"
    )

    parser.add_argument(
        '--data_dir',
        type=str,
        default=r"G:\My Drive\PhD_BanglaOCT2025_data\BanglaOCT2025\FFSwin_classifi_Split_Train_Valid_Test_DenoisData",
    ...
    parser.add_argument('--save_dir', type=str, default="./checkpoints_resnet3d")
    ...
    class ResNet3D18_OCT(nn.Module):
        def __init__(self, num_classes=3):
            ...
            self.model.stem[0] = nn.Conv3d(
                1, 64,
                kernel_size=(3, 7, 7),
                stride=(1, 2, 2),  # no early depth collapse
                padding=(1, 3, 3),
                bias=False
            )
    ...
    best_model_path = os.path.join(args.save_dir, "resnet3d18_best.pth")
    final_model_path = os.path.join(args.save_dir, "resnet3d18_final.pth")
